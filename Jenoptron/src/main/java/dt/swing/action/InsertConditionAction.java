 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class InsertConditionAction extends AbstractAction {
    private static final long serialVersionUID = 761374236975419655L;
	private final DTTable table;
	
	public InsertConditionAction( final DTTable table) {
		super();
		this.table = table;
	}
	/* (non-Javadoc)
	...
	public void actionPerformed( final ActionEvent e) {
		...
		ActionUtil.insertCondition(decisionTable, table.getRowSelected());
		table.refresh();
	}
