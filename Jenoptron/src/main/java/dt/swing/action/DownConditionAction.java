 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DownConditionAction extends AbstractAction {
    private static final long serialVersionUID = 761374236975419655L;
	private final DTTable table;
	
	public DownConditionAction( final DTTable table) {
		super();
		this.table = table;
	}
	/* (non-Javadoc)
	...
	public void actionPerformed(final ActionEvent e) {
		...
		ActionUtil.down( decisionTable, table.getRowSelected());
		table.refresh();
	}
}
