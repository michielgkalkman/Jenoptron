...
public class CategoriesCentral extends JPanel implements ActionListener {
	private static final long serialVersionUID = -7869076279080734717L;
	private final IDecisionTable decisionTable;
	
	public CategoriesCentral( final IDecisionTable decisionTable) {
		super();
	...
	private JComponent getTablePropsComponent() {
		...
		final JButton addRule = new JButton( "Add Category");
	...
	public void actionPerformed( final ActionEvent e) {
		decisionTable.add( new ExclusiveConditionsGroup( "Category " + decisionTable.getRules().size() ));
	}
}
