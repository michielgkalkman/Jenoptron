...
public class BinaryActionValue implements IValue {
	...
	static {
		final List<IValue> tmpSelectableValuesList = new ArrayList<>();
		// @todo: report the following - it does not work !
		// Arrays.fill( binaryActionValues, possibleValuesList);
		Collections.addAll(tmpSelectableValuesList, binaryActionValues);
	...
	public static IValue parse(final String string) {
		final IValue value;
